...
def _resolve_model_id(model_cfg: dict, training_cfg: dict, lime_cfg: dict) -> str:
...
def run(cfg: dict) -> None:
    ...
    model_id = _resolve_model_id(model_cfg, training_cfg, lime_cfg)
    ...
    _save_histogram(
        ...
        "Kendall Tau (LIME Consistency)",
        "Kendall Tau",
    )
    _save_histogram(
        metrics_topk,
        figures_dir / "lime_topk_hist.png",
        "Top-k Overlap (LIME Consistency)",
        "Top-k Overlap",
    )
    _save_histogram(
        metrics_cos,
        figures_dir / "lime_cosine_hist.png",
        "Cosine Similarity (LIME Consistency)",
        "Cosine Similarity",
    )
